...
const Detail = () =>{
    ...
    <SafeAreaView style={{ flex:1}}>    
        <View style={styles.container}>
            ...
            <Image style={styles.pointImage} source={{uri:'https://images.unsplash.com/photo-1550989460-0adf9ea622e2?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&q=60'}} />
